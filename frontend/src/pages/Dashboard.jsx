...
//   const cities = [
//     "los angeles", "phoenix", "miami", "chicago", "new york",
//     "dallas", "atlanta", "houston", "denver", "seattle"
//   ];
...
//                   className="w-full border border-gray-300 rounded-lg px-4 py-3 text-left focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white hover:bg-gray-50 transition-colors flex items-center justify-between"
//                 >
...
//                       <span className="text-xs font-medium text-gray-500">SELECT CITIES</span>
...
//                         <label
//                           key={city}
//                           className="flex items-center space-x-3 px-3 py-2 hover:bg-gray-50 rounded-lg cursor-pointer transition-colors"
//                         >
//                           <input
//                             type="checkbox"
...
//                     className={`bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center space-x-2 ${
//                       selectedCities.length === 0 ? 'opacity-50 cursor-not-allowed' : ''
//                     }`}
//                   >
...
//                       <span className="text-yellow-700 font-medium">Scraping in progress...</span>
//                     </div>
//                     <button
//                       onClick={cancelScrape}
//                       className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
//                     >
//                       Cancel Scrape
//                     </button>
//                   </div>
              ...
              <div>
                {!scraping ? (
                  <button
                    ...
                    className={`bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-200 shadow-md hover:shadow-lg flex items-center space-x-2 ${
                      selectedCities.length === 0 || loadingCities ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  >
                    <RefreshCw className="w-5 h-5" />
                    <span>Start Scraping</span>
